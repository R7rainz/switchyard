...
func TestHealthzNeedsNoToken(t *testing.T) {
	router := NewRouter(&stubVerifier{accept: "good"})
...
func TestClaimsReachHandlerThroughContext(t *testing.T) {
	...
	handler := RequireAuth(&stubVerifier{accept: "good"})(http.HandlerFunc(func(_ http.ResponseWriter, r *http.Request) {
